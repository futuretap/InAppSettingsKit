...
- (id)initWithFile:(NSString*)urlString specifier:(IASKSpecifier*)specifier {
	if ((self = [super init])) {
		...
		self.fullscreen = [[specifier.specifierDict objectForKey:kIASKWebViewFullscreen] boolValue];
...
- (void)viewDidLoad {
	...
	UILayoutGuide *referenceView = self.fullscreen ? (id)self.view : self.view.safeAreaLayoutGuide;
	[NSLayoutConstraint activateConstraints:@[
		[self.webView.topAnchor constraintEqualToAnchor:referenceView.topAnchor],
